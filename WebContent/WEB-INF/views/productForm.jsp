...
<head>
<link href="<c:url value="/stylesheet/css/bootstrap.min.css" />"
	rel="stylesheet">
			...
			<fieldset>
				<table style="margin-left: 500px;margin-top: 100px">
					...
					<tr class="success">
						...
						<td class="info"><label for="description">Description: </label></td>
					...
					<tr class="success">
						<td><input id="reset" type="reset" tabindex="4" class="btn btn-info"></td>
						<td class="info"><input id="submit" type="submit" tabindex="5" value="Add Product" class="btn btn-success"></td>
					</tr>
